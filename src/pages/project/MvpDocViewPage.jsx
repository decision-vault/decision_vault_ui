...
export function MvpDocViewPage() {
  ...
  const [manualMdContent, setManualMdContent] = useState(PRD_CONTENT)
  ...
  return (
    <Flex style={{ width: '100%', height: '100%', minHeight: 0, overflow: 'hidden' }}>
        ...
        <Box style={{ flex: 1, minHeight: 0, overflow: 'auto', padding: 12 }}>
          {editMessages.length === 0 ? (
            <Text size="2" color="gray">
              Ask for changes to the document. Your edits will appear here.
            </Text>
          ) : (
      ...
      >
        {hasDocContent && (
          <Flex p="2" gap="2" style={{ borderBottom: '1px solid var(--gray-6)', flexShrink: 0 }}>
            <Button
              size="1"
